...
class XmlConsts {
  ...
  static const code='code';// added to IntelliGrade
...
class Quiz {
  ...
  */
  ...
  Quiz(List<Question> questions, {this.name, this.description, List<Question>? questionList})
...
class Question {
  ...
  // Simple constructor.
  Question(String s, String k, String n, {//(String s,String s, String s is changed into (String s, String k, String n,))
    required this.name,
    required this.type,
...
enum QuestionType {//defines a collection of constant values/represent a fixed set of related values.
...
class FileNameAndBytes {
  ...
  final Uint8List bytes;//used for better performance
