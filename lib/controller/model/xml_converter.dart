...
import 'package:assignment_generator/controller/model/html_converter.dart';
import 'beans.dart';
...
class XmlConverter {
  ...
  static get html_Converter async => null;//created to avoid error
  ...
  static String getShortenedDesc(String description) {
    int charLimit = 30;
    String desc = html_Converter.convert(description.trim());
